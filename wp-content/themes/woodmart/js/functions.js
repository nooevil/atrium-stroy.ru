		...
		return {
			...
			hideShopSidebar: function () {
				...
				if (!woodmartTheme.disableNanoScrollerWebkit && woodmart_settings.disable_nanoscroller != 'disable') {
					$('.sidebar-inner.woodmart-scroll').nanoScroller({
						destroy: true
					});
				}
			},
...
(function ($) {
	...
	woodmartThemeModule.sortByWidget = function () {
		...
		jQuery('.woocommerce-ordering > input').on('change', () => {
			// console.log("ggg =>");
			// $('.woocommerce-ordering').submit();

			var $form = $(".woocommerce-ordering").closest('form');
			...
			woof_submit_link(url, false);

			// console.log(url, woodmart_settings.pjax_timeout);

			// $(document).on('pjax:error', function(xhr, textStatus, error, options) {
			// 	console.log(xhr, textStatus, error, options);
			// });

			// console.log(woof_ajaxurl);
